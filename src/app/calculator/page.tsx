...
export default async function CalculatorPage() {
  ...
  return <main id="main" className="shell professional-page"><header><span className="eyebrow">ZARSIGNAL CALCULATOR</span><h1>هر محاسبه، با ورودی روشن.</h1><p>محاسبه را انتخاب کنید، قیمت را وارد یا از بازار دریافت کنید و نتیجه را ببینید.</p></header><ProfessionalCalculator snapshot={snapshot}/></main>;
}
