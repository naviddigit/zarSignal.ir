    ...
    <main id="main" className="shell home-page">
      ...
      <section className="hero">
        <div className="hero-copy hero-reveal">
          ...
          <h1>بازار را واضح ببین.<br /><span className="gold-text">با آگاهی تصمیم بگیر.</span></h1>
          <p>قیمت را ببین؛ فاصله‌اش با ارزش محاسباتی را هم ببین.<br />ساده، شفاف، بدون ادعای تضمین سود.</p>
